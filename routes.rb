...
api_discussion_comment_likes POST   /api/discussions/:discussion_id/comments/:comment_id/likes(.:format)     api/likes#create
 api_discussion_comment_like DELETE /api/discussions/:discussion_id/comments/:comment_id/likes/:id(.:format) api/likes#destroy
     api_discussion_comments GET    /api/discussions/:discussion_id/comments(.:format)                       api/comments#index
      ...
      api_discussion_comment DELETE /api/discussions/:discussion_id/comments/:id(.:format)                   api/comments#destroy
              api_discussion GET    /api/discussions/:id(.:format)                                           api/discussions#show
     ...
     api_project_attachments POST   /api/projects/:project_id/attachments(.:format)                          api/attachments#create
